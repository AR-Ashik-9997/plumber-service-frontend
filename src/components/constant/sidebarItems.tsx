...
const RoleBasedList = ({ role }: { role: string }) => {
  ...
  const adminSidebarItems = () => {
    return (
      <React.Fragment>
              ...
              <React.Fragment>
                ...
                >
                  <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                    <li>
                      <Link
                        href="/admin/usermanage/createUser"
                    ...
                    <li>
                      <Link
                        href="/admin/usermanage/viewUser"
                        className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${
                          pathname === "/" && "text-white"
                        } `}
                      >
              ...
              <React.Fragment>
                ...
                >
                  <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                    <li>
                      <Link
                        href="/admin/servicemanage/createService"
                        className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${
                          pathname === "/" && "text-white"
                        } `}
                      >
                    ...
                    <li>
                      <Link
                        href="/admin/servicemanage/viewService"
                        className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${
                          pathname === "/" && "text-white"
                        } `}
                      >
              ...
              <React.Fragment>
                ...
                >
                  <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                    <li>
                      <Link
                        href="/admin/bookingmanage/viewAllBookings"
                        className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${
                          pathname === "/" && "text-white"
                        } `}
                      >
              ...
              <React.Fragment>
                ...
                >
                  <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                    <li>
                      <Link
                        href="/admin/contentmanage/blogmanage/createBlogs"
                        className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${
                          pathname === "/" && "text-white"
                        } `}
                      >
                    ...
                    <li>
                      <Link
                        href="/admin/contentmanage/blogmanage/viewAllBlogs"
                        className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${
                          pathname === "/" && "text-white"
                        } `}
                      >
        ...
        <SidebarLinkGroup
          activeCondition={pathname === "/" || pathname.includes("Profile")}
        >
          {(handleClick, open) => {
            return (
              <React.Fragment>
                ...
                >
                  <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                    ...
                    <li>
                      <Link
                        href="/admin/profilemanage/changePassword"
                        className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${
                          pathname === "/" && "text-white"
                        } `}
                      >
              ...
              <React.Fragment>
                ...
                >
                  <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                    ...
                    <li>
                      <Link
                        href="/superadmin/adminmanage/viewAllusers"
                        className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${
                          pathname === "/" && "text-white"
                        } `}
                      >
  ...
  if (role === USER_ROLE.ADMIN) {
    return <div>{adminSidebarItems()}</div>;
  } else if (role === USER_ROLE.SUPER_ADMIN) {
    return <div>{superAdminSidebarItems()}</div>;
  } else if (role === USER_ROLE.USER) {
    return <div>{userSidebarItems()}</div>;
  }
};
